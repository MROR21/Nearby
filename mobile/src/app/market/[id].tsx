...
import { Cover } from "@/comoponents/market/cover"
import { Coupon } from "@/comoponents/market/coupon"
import{Details, PropsDetails} from "@/comoponents/market/details"
...
function handleUseCoupon(id: string){ //apagaaaaa
    setIsVisibleCameraModal(false)

    Alert.alert("Cupom", "Deseja realmente resgatar o cupom?.", //Não é possivel reultilizar um cupom resgatado. 
